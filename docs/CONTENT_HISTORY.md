# Historical content and artwork notes

Archived September 22, 2026. This is a record of earlier changes and source research, **not the current specification**. Some entries describe removed features, superseded recommendations, or earlier checks. Use the [current source and maintenance index](../CONTENT_SOURCES.md) and its linked guides when editing the site.

The original notes, artwork prompts, and asset provenance are preserved below. The relative documentation link has been adjusted for this archive location.

---

# Content and image sources

Latest gear audit: [Master Mode loadout content and editing guide](LOADOUT_CONTENT.md), September 17, 2026. All classes and roadmap stops have complete equipped accessory builds, with weapon-specific replacements listed separately.
