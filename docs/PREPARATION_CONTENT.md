...
Curated for the guide's Desktop **1.4.5.7**, Master Mode, ordinary-world first clears. Reviewed September 17, 2026. Recommendations are useful options, not a requirement to farm every buff.
...
- `src/PreparationGuide.jsx`: the three-column presentation; stacks on small screens. Only rendered within the gearing roadmap's equipment guide.
...
- Weapon flasks require Queen Bee's Witch Doctor and Imbuing Station. Pre-Skeletron uses Fire; Wall of Flesh uses Poison. Hardmode offers Ichor/Cursed Flames; post-Plantera adds Venom. Only one flask at a time; they work with whips, not minion attacks. The Destroyer's immunity is called out.
...
- [Flasks](https://terraria.wiki.gg/wiki/Flasks), [Flask of Ichor](https://terraria.wiki.gg/wiki/Flask_of_Ichor), [Witch Doctor](https://terraria.wiki.gg/wiki/Witch_Doctor), [Wall of Flesh preparation](https://terraria.wiki.gg/wiki/Guide:Wall_of_Flesh_strategies).
