...
// Sources are the corresponding Official Terraria Wiki pages, checked September 16, 2026.
...
export const checklistSpawns = {
  ...
  'pre-boss': entry('Eye_of_Cthulhu', 'Use a Suspicious Looking Eye at night.', 'Night: 7:30 PM–4:30 AM; it leaves at dawn.', 'Can appear before its first defeat with 200 maximum health, 11 defense, and four town NPCs present (including the Old Man). Stay above ground.'),
  'evil-boss': {
    variants: [
